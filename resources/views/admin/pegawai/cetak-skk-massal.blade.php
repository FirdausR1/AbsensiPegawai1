...
<head>
    ...
    <title>Cetak SKK Massal - {{ $siteName }}</title>
    ...
    <div class="max-w-4xl mx-auto mb-6 flex items-center justify-between no-print">
        <div>
            ...
            <div class="text-xs text-slate-500 font-bold mt-1">
                Menampilkan <strong>{{ count($pegawais) }} Surat Keterangan Bekerja</strong> untuk Site: <span class="text-[#000d6b]">{{ $siteName }}</span>
            </div>
        </div>
        ...
        <button onclick="window.print()" class="px-6 py-2.5 bg-[#000d6b] hover:bg-[#001253] text-white text-xs font-bold rounded-xl shadow-md transition flex items-center gap-2">
            ...
            Cetak Seluruh SKK Massal ({{ count($pegawais) }} Pegawai)
        </button>
    </div>
